  ...
  return (
    <div className="d-flex flex-column text-white" id='sidebar-container'>
      <a href="/dashboard" className="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-white text-decoration-none">
        <span className="fs-3 p-3" id='learnia-logo'>Learn-IA</span>
      </a>

      <div className="full-width-container">
        <Link
          to="/perfil"
          className={`nav-link d-block text-white ${activePath === '/perfil' ? 'active' : ''}`}
          onClick={() => setActivePath('/perfil')}
          >
          <div className="row py-2">
            <div className="col-12 col-md-3 ps-4">
              <img src="https://github.com/mdo.png" className="rounded-circle" id='profile-image'/>
            </div>
    ...
    <ul className="nav flex-column mb-auto">
      <li className="nav-item">
        <Link
            to="/dashboard"
            className={`nav-link d-block text-white ${activePath === '/dashboard' ? 'active' : ''}`}
      ...
      <li>
        <Link
            to="/MisCursos"
            className={`nav-link d-block text-white ${activePath === '/MisCursos' ? 'active' : ''}`}
      ...
      <li>
        <Link
              to="/HistorialQuizzes"
              className={`nav-link d-block text-white ${activePath === '/HistorialQuizzes' ? 'active' : ''}`}
      ...
      <li>
        <Link
            to="/explora"
            className={`nav-link d-block text-white ${activePath === '/explora' ? 'active' : ''}`}
    ...
    <ul className="nav flex-column mb-auto">
      <li className="nav-item">
        <Link
              to="/ayuda"
              className={`nav-link d-block text-white ${activePath === '/ayuda' ? 'active' : ''}`}
      ...
      <li>
        ...
        <i className="bi bi-box-arrow-in-right" style={{marginLeft: "-4px"}}></i>
          Cerrar sesión
        </a>
      </li>
      </ul>
