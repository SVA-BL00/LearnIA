...
const questions = [
  {
    "question": "¿Cuál de las siguientes acciones representa una implementación científica o ingenieril adecuada para un problema de optimización de recursos?",
    "options": [
    ...
    "correct_answer": "Desarrollar un modelo de simulación para evaluar diferentes escenarios."
  },
  {
    "question": "Para resolver un problema de ingeniería con un alto nivel de incertidumbre, ¿qué enfoque es más adecuado?",
    "options": [
  ...
  {
    "question": "En el contexto de la ingeniería y las ciencias, ¿qué significa aplicar los principios de sustentabilidad?",
    "options": [
    ...
    "correct_answer": "Desarrollar tecnologías que mitiguen el impacto ambiental y promuevan el uso eficiente de recursos."
  },
  {
    "question": "¿Cuál de las siguientes estrategias es más adecuada para garantizar el bienestar de las generaciones futuras?",
    "options": [
    ...
    "correct_answer": "Implementar políticas que promuevan la reducción, reutilización y reciclaje de materiales."
  },
  {
    "question": "En la implementación de procesos computacionales, ¿qué factor es crucial para asegurar que la solución sea adecuada?",
    "options": [
    ...
    "correct_answer": "La alineación del proceso computacional con los requisitos del problema específico."
  }
];
  ...
  return (
    <div style={{ marginLeft: '400px' }}>
      <div className="wrapper-quiz">
        <div className="quiz-title Ubuntu" style={{ backgroundColor: 'var(--green-color)' }}>
          Modelación de la ingeniería y ciencias
        </div> {/* cambiar a que se envíe el titulo desde la base de datos */}
        {showScore ? (
          <div className='score-section'>
            <h1 style={{ color: 'var(--green-color)' }} className='Roboto'>Resultado</h1>
            <p className='fw-bold' style={{ color: 'var(--green-color)' }}>Has obtenido {score} de {questions.length} correctas.</p>
            ...
            <div className='Lato'>
              ...
              <ul>
                {questions.map((question, index) => (
                  <li key={index}>
                    {question.question} - Tu respuesta: {userAnswers[index]} - Correcta: {question.correct_answer}
                  </li>
                ))}
              </ul>
            </div>
          ...
          <div className="quiz-body Lato">
            <div className='quiz-header'>
              <div style={{ color: 'var(--green-color)' }} className='fw-bold fst-italic'>
                <i className="bi bi-pencil-square" style={{ fontSize: '1.5em' }} />
            ...
            <div className='navigation-buttons'>
              ...
              {currentQuestion < questions.length - 1 ? (
                ...
                <button onClick={handleSubmitClick} disabled={selectedOption === null} style={{backgroundColor: 'var(--red-color)'}}>
                  Enviar
                </button>
              )}
            </div>
